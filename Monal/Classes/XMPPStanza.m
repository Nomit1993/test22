...
{
    MLXMLNode* delay = [[MLXMLNode alloc] initWithElement:@"delay" andNamespace:@"in:secure:signal:delay"];
...
-(void) inviteuserRoom:(NSString *)userJid
{
    ...
    [inviteNode.attributes setObject:userJid forKey:@"from"];
    MLXMLNode *reasonNode = [[MLXMLNode alloc] initWithElement:@"reason"];
    reasonNode.data = userJid;
