...
//     DDLogDebug(@"Started element: %@ :: %@ (%@) depth %ld", elementName, namespaceURI, qName, _depth);
    ...
    MLXMLNode* newNode;
    if(_depth == 2 && [elementName isEqualToString:@"iq"] && [namespaceURI isEqualToString:@"c5b9cdd82abcf6305f9c24fa5b7715e15dfe36fa810852494dad0297fd9dc866:client"])
        newNode = [XMPPIQ alloc];
    else if(_depth == 2 && [elementName isEqualToString:@"message"] && [namespaceURI isEqualToString:@"c5b9cdd82abcf6305f9c24fa5b7715e15dfe36fa810852494dad0297fd9dc866:client"])
        newNode = [XMPPMessage alloc];
    else if(_depth == 2 && [elementName isEqualToString:@"presence"] && [namespaceURI isEqualToString:@"c5b9cdd82abcf6305f9c24fa5b7715e15dfe36fa810852494dad0297fd9dc866:client"])
