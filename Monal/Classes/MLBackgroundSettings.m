...
- (void)viewDidLoad {
    ...
    self.imageList = @[@"Golden_leaves_by_Mauro_Campanelli",
                       ...
                       @"Winter_Fog_by_Daniel_Vesterskov",@"theme1",@"theme2",@"theme3",@"theme4",@"theme5",@"theme6",@"theme7",@"theme8",@"theme9",@"theme10",@"theme11",@"theme12",@"theme13",@"theme14",@"theme15",@"theme16",@"theme17",
                       ];
}
