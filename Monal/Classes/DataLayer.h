...
extern NSString* const KMessageTypeReply;
extern NSString* const KMessageDecrypt;
extern NSString* const kMessageTypeUrl;
extern NSString* const kMessageTypeFiletransfer;
extern NSString *const kMessageTypeImageCaption;

extern NSString *const kMessageTypeCreateGroup;
extern NSString *const kMessageTypeAddMember;
extern NSString *const kMessageTypeChangedGroupSubjectName;
extern NSString *const kMessageTypeChangedGroupInfo;
extern NSString *const kMessageTypeChangedGroupSubjectName;
extern NSString *const kMessageTypeChangedGroupInfo;
