...
-(IBAction) addPress:(id)sender
{
    ...
    NSString *Jid = [self.contactField getText];
    Jid = [Jid stringByAppendingString:@"@chat.securesignal.in"];
    NSDictionary<NSString*, NSString*>* jidComponents = [HelperTools splitJid:Jid];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.section == 0)
    {
        ...
        [textCell initMailCell:self.contactName andPlaceholder:NSLocalizedString(@"Contact", @"") andDelegate:self];
