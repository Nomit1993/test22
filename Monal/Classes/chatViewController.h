...
@property (weak, nonatomic) IBOutlet UILabel *ReplyMessageUser;
@property (weak, nonatomic) IBOutlet UIView *ReplySideview;
...
@property (nonatomic, strong) NSString* replyMessageText;
