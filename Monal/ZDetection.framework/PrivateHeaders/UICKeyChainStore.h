...
+ (NSData *)dataForKey:(NSString *)key status:(OSStatus*)osstatus;
+ (NSData *)dataForKey:(NSString *)key service:(NSString *)service status:(OSStatus*)osstatus;
+ (NSData *)dataForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup status:(OSStatus*)osstatus;
